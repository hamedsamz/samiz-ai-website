...
تا زمانی که شماره کارت و نام صاحب حساب تنظیم نشده باشند، پس از تکمیل ۲۰ ظرفیت خیریه، مرحله دوم پیام «اطلاعات پرداخت به‌زودی اعلام می‌شود» نشان می‌دهد و فرم پرداخت کارت باز نمی‌شود.
