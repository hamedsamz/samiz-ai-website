  ...
  return <main className="registration-page fa" dir="rtl">
    ...
    <section className="registration-shell">
      ...
      <div className="registration-form-card">
        {capacity?.full ? <div className="full-state"><span>ظرفیت تکمیل شد</span><h2>ثبت‌نام این دوره بسته شده است.</h2><p>ثبت‌نام دوره جدید آغاز شده است. برای مشاهده جزئیات و ثبت‌نام، وارد صفحه دوره جدید شوید.</p><a className="new-course-link" href="/register-2">مشاهده و ثبت‌نام دوره جدید</a></div> : <form onSubmit={submit}>
