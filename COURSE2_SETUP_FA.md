...
لینک کانال تلگرام دوره جدید به‌عنوان مقدار پیش‌فرض داخل پروژه قرار گرفته است. در صورت تغییر کانال، می‌توان مقدار `COURSE2_TELEGRAM_URL` را در Vercel جایگزین کرد.
