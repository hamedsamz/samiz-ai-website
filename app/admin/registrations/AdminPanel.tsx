...
export default function AdminPanel() {
  ...
  return <>
    <div className="admin-stats"><div><span>در انتظار بررسی</span><strong>{pending}</strong></div><div><span>تأییدشده از ۳۰ نفر</span><strong>{approved}</strong></div><div><span>کل درخواست‌ها</span><strong>{items.length}</strong></div></div>
