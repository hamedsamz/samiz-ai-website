  ...
  return (
    <main className="admin-page coding-admin fa" dir="rtl">
      <header className="admin-header">
        ...
        <div><Link href="/admin/ai-video-course">دوره ویدیو</Link><Link href="/admin/registrations-2">دوره پرامپت</Link><Link href="/coding-vibe-coding">صفحه ثبت‌نام</Link><Link href="/">سایت اصلی</Link></div>
      </header>
